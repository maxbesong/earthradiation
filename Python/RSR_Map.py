# This script creates a contour map of the mean RSR values at each location
...
plt.savefig('/Users/maxbesong/Desktop/Research with Python/Scripts/RSR_Map.png', bbox_inches='tight', dpi=200)
plt.show()
